...
CREATE TABLE IF NOT EXISTS `tucha`.`animal` (
  ...
  `current_situation` VARCHAR(128) NULL,
  `missing_details` VARCHAR(2048) NULL,
  `death_date` DATE NULL,
  `death_reason` VARCHAR(2048) NULL,
  `is_deleted` INT(1) NULL,
  `picture` MEDIUMBLOB NULL,
  `picture_thumbnail` MEDIUMBLOB NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tucha`.`state` (
  ...
  PRIMARY KEY (`id`),
  INDEX `state_animal_idx` (`animal` ASC),
