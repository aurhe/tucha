...
-- Schema tucha
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tucha` DEFAULT CHARACTER SET utf8 ;
USE `tucha` ;
...
CREATE TABLE IF NOT EXISTS `tucha`.`person` (
  ...
  `volunteer` INT(1) NULL,
  `associate` INT(1) NULL,
  `last_paid_fee` INT NULL,
...
-- Table `tucha`.`photos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tucha`.`photos` ;

CREATE TABLE IF NOT EXISTS `tucha`.`photos` (
  `id` INT NOT NULL,
  `photo` MEDIUMBLOB NULL,
  `photo_wh50` MEDIUMBLOB NULL,
  `photo_w250` MEDIUMBLOB NULL,
  `photo_h100` MEDIUMBLOB NULL,
  `photo_h500` MEDIUMBLOB NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
